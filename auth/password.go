...
//
// Adapted from https://github.com/alexedwards/argon2id/blob/master/argon2id.go, Alex Edwards
func CreateHash(password string, p *params) (encodedHash string, err error) {
